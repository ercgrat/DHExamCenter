...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:math="http://exslt.org/math"
    ...
    <xsl:template match="root">
        ...
        <svg class="donut_chart" height="100%" width="100%" xmlns="http://www.w3.org/2000/svg" data-identifier="{@identifier}">
            <xsl:for-each select="object">
				...
				<circle cx="{$cx}" cy="{$cy}" r="{$donut_radius}" stroke="none" fill="transparent">
